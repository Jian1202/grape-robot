...
yolo detect train \
  model=yolov8n.pt \
  data=data/yolo/grape.yaml \
  imgsz=640 \
  epochs=80 \
  batch=8 \
  project=runs/grape \
  name=yolov8n_grape_v1
```
...
```text
runs/grape/yolov8n_grape_v1/weights/best.pt
runs/grape/yolov8n_grape_v1/weights/last.pt
runs/grape/yolov8n_grape_v1/results.png
runs/grape/yolov8n_grape_v1/confusion_matrix.png
```
...
```bash
yolo detect predict \
  model=runs/grape/yolov8n_grape_v1/weights/best.pt \
